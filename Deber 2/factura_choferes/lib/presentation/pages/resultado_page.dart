...
import 'package:factura_choferes/presentation/atoms/labels/label.dart';
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Label(
                      title: 'Total a Pagar',
                      value:
                          '\$${widget.controller.getTotalGeneralNomina().toStringAsFixed(2)}',
                      fontSize: 20,
                      isBold: true,
                    ),
                    ...
                    Label(
                      ...
                      value:
                          '${widget.controller.getTotalHorasLunes().toStringAsFixed(1)} horas',
                      fontSize: 16,
                    ),
                  ],
                ),
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      ResultLabel(
                        text:
                            'Estado: ${chofer.esActivo ? 'Activo' : 'Inactivo'}',
                      ),
                      ResultLabel(
                        text:
                            'Recibe Bono: ${chofer.recibeBono ? 'Sí (10%)' : 'No'}',
                      ),
                      ResultLabel(
                        text:
                            'Sueldo por Hora: \$${chofer.sueldoPorHora.toStringAsFixed(2)}',
                      ),
                      ...
                      ...List.generate(6, (diaIndex) {
                        return ResultLabel(
                          text:
                              '  ${dias[diaIndex]}: ${chofer.horasPorDia[diaIndex].toStringAsFixed(1)} horas',
                          fontSize: 12,
                        );
                      }),
                      const SizedBox(height: 10),
                      ResultLabel(
                        text:
                            'Total Horas Semanales: ${chofer.totalHorasSemanal.toStringAsFixed(1)} horas',
                        highlight: true,
                      ),
                      ResultLabel(
                        text:
                            'Sueldo Base: \$${chofer.sueldoSemanal.toStringAsFixed(2)}',
                      ),
                      if (chofer.recibeBono)
                        ResultLabel(
                          text:
                              'Bono (10%): \$${chofer.montoBonoAdicional.toStringAsFixed(2)}',
                        ),
                      ResultLabel(
                        text:
                            'Sueldo Final: \$${chofer.sueldoFinal.toStringAsFixed(2)}',
                        highlight: true,
                        fontSize: 15,
                      ),
                    ],
